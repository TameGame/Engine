    ...
    export class StandardGame implements Game {
        constructor(initialSize: Size, messageDispatcher: WorkerMessageDispatcher) {
            ...
            var runPass = (pass: UpdatePass, milliseconds: number, sceneChanges: { scene: InternalScene; watchers: RegisteredWatchers; changes: Watcher }[] , callback?: () => void) => {
                ...
                recentChanges.dispatchChanges(pass, _watchers);
            ...
            var onPass = (updatePass: UpdatePass, callback: (milliseconds: number) => void) => {
                // TODO: implement me
            }
            var everyPass = (updatePass: UpdatePass, callback: (milliseconds: number) => void): Cancellable => {
                // TODO: implement me
                return null;
            }
